...
using ESerranoEcoConnect.Models.ViewModels;//update this namespace to match your project structure
using ESerranoEcoConnect.Models;//update this namespace to match your project structure
